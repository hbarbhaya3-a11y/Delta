...
export const SCB_RECOMMENDATIONS = [
  {
    ...
    assignments: [
      { kind: 'Stranded crew', kindColor: 'red', resource: 'Cockpit P4471 — Capt C-ATL-2210, FO C-ATL-2214', from: 'ORD (stuck)', to: 'ATL domicile', flight: 'DHD DL2214 ORD–ATL 17:05', action: 'Deadhead home; legal reset for next-day AM report' },
      { kind: 'Stranded crew', kindColor: 'red', resource: 'FA pairing P4488 — lead F-JFK-3391 + 3 FAs', from: 'ORD (stuck)', to: 'JFK domicile', flight: 'DHD DL1885 ORD–JFK 17:40', action: 'Deadhead home; protects the 10-hr rest window' },
      { kind: 'Reserve', kindColor: 'orange', resource: 'R-ATL-08, R-ATL-12', from: 'ATL reserve pool', to: 'open leg from P4471', flight: 'DL2537 ATL–MCO 18:20', action: 'Bridge the leg the stranded ATL cockpit can no longer fly' },
      { kind: 'Reserve', kindColor: 'orange', resource: 'R-JFK-03, R-JFK-05', from: 'JFK reserve pool', to: 'open JFK evening leg', flight: 'DL1729 JFK–BOS 20:15', action: 'Cover the open JFK bank leg, legal + qualified' },
      { kind: 'Crew', kindColor: 'red', resource: 'FO C-ATL-2246 (reassigned within P4462)', from: 'held ATL leg', to: 'remaining rotation leg', flight: 'DL2611 ATL–BOS 19:05', action: 'Rebuild the remaining rotation instead of opening a new trip' },
      { kind: 'Tail', kindColor: 'grape', resource: 'N823DN (maintenance-ready)', from: 'ATL spare', to: 'ATL–BOS rotation', flight: 'DL2611 ATL–BOS 19:05', action: 'Tail swap to unblock the leg so the reassigned crew can operate' },
      { kind: 'Flight', kindColor: 'yellow', resource: '5 protected-bank flights (DL2537, DL2611, DL2705, DL1729, DL2390)', to: '≤45 min hold', action: 'Delay to align deadhead arrivals + reserve report times' },
      { kind: 'Passenger', kindColor: 'blue', resource: '520 at-risk pax', to: 'protected connections', action: 'Early reaccommodation on held/covered legs, premium first' },
    ],
  ...
  },
  {
    ...
    assignments: [
      { kind: 'Flight', kindColor: 'yellow', resource: '6 low-criticality legs (DL2705 ATL–GSP, DL2811 ATL–CHS, DL2933 ATL–TYS, +3)', to: 'cancelled / thinned', action: 'Cut demand so core banks keep crew + tails' },
      { kind: 'Crew', kindColor: 'red', resource: 'Released crew C-ATL-2246, C-ATL-2311 + stranded P4462', from: 'cancelled legs / ORD', to: 'ATL / JFK critical bank', flight: 'DL2611 ATL–BOS, DL1729 JFK–BOS', action: 'Reassign to protect connection-heavy departures' },
      { kind: 'Reserve', kindColor: 'orange', resource: 'R-ATL-08…16, R-JFK-03…07 (held)', to: 'critical banks only', action: 'Preserve the reserve pool by cutting demand first' },
      { kind: 'Passenger', kindColor: 'blue', resource: '740 at-risk pax', to: 'alternate itineraries', action: 'Reaccommodate cancelled-leg passengers, premium first' },
    ],
